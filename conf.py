# -*- coding: utf-8 -*-
#
# I09N documentation build configuration file, created by
# sphinx-quickstart on Sat Feb 13 11:28:46 2016.
#
...
exclude_patterns = ["_build", "as_received"]
...
latex_additional_files = ["sensor-calib.pdf"]
...
subs = {
    ...
    "13C": ":sup:`13`\ C",
    "14C": ":sup:`14`\ C",
    "d15N": ":math:`\delta`\ :sup:`15`\ N",
    "d18N": ":math:`\delta`\ :sup:`18`\ N",
    "d18O": ":math:`\delta`\ :sup:`18`\ O",
    "d13C": ":math:`\delta`\ :sup:`13`\ C",
    "d14C": ":math:`\delta`\ :sup:`14`\ C",
    "NO3": "NO\ :sup:`3`",
    "N2O": "N\ :sub:`2`\ O",
    "N2": "N\ :sub:`2`",
    "NO2": "NO\ :sub:`2`",
...
rst_epilog = "\n".join(
    [
        ".. |{key}| replace:: {value}".format(key=key, value=value)
